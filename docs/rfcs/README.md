...
| RFC | Title | Status |
| --- | --- | --- |
| [0001](0001-memory-model.md) | Memory-management strategy (arena vs GC vs ownership) | Implemented (Boehm GC, v0.44.0) |
...
| [0005](0005-enum-match.md) | Sum types (`enum`) and pattern matching (`match`) | Implemented (v0.45.0) |
