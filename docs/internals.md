...
| `E01xx`  | names / arity / modules   | `E0100` no `main`, `E0101` undefined var, `E0102` undefined fn, `E0103` duplicate fn, `E0104` wrong arity, `E0105` import not found, `E0106` private item used across files |
